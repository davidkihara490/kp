...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('ui/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('ui/plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css') }}">
    <!-- BS Stepper -->
    <link rel="stylesheet" href="{{ asset('ui/plugins/bs-stepper/css/bs-stepper.min.css') }}">
    <!-- dropzonejs -->
    <link rel="stylesheet" href="{{ asset('ui/plugins/dropzone/min/dropzone.min.css') }}">
    <!-- Theme style -->
...
<body class="hold-transition sidebar-mini">
    ...
    <!-- Bootstrap4 Duallistbox -->
    <script src="{{ asset('ui/plugins/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js') }}"></script>
    <!-- InputMask -->
    <script src="{{ asset('ui/plugins/moment/moment.min.js') }}"></script>
    <script src="{{ asset('ui/plugins/inputmask/jquery.inputmask.min.js') }}"></script>
    <!-- date-range-picker -->
    <script src="{{ asset('ui/plugins/daterangepicker/daterangepicker.js') }}"></script>
    <!-- bootstrap color picker -->
    <script src="{{ asset('ui/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js') }}"></script>
    <!-- Tempusdominus Bootstrap 4 -->
    <script src="{{ asset('ui/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js') }}"></script>
    <!-- Bootstrap Switch -->
    <script src="{{ asset('ui/plugins/bootstrap-switch/js/bootstrap-switch.min.js') }}"></script>
    <!-- BS-Stepper -->
    <script src="{{ asset('ui/plugins/bs-stepper/js/bs-stepper.min.js') }}"></script>
    <!-- dropzonejs -->
    <script src="{{ asset('ui/plugins/dropzone/min/dropzone.min.js') }}"></script>
    <!-- AdminLTE App -->
            ...
            tinymce.init({
                ...
                setup: function(editor) {
                    ...
                    editor.on('init', function() {
                        const model = editor.getElement().dataset.model;
                        const component = Livewire.find(editor.getElement().closest('[wire\\:id]').getAttribute('wire:id'));
                        editor.setContent(component.get(model) || '');
                    });

                    editor.on('keyup change', function() {
                        const model = editor.getElement().dataset.model;
                        const component = Livewire.find(editor.getElement().closest('[wire\\:id]').getAttribute('wire:id'));
                        component.set(model, editor.getContent());
                    });
                }
            });
        });
