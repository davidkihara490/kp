                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                                <div class="pe-lg-4">
                                    ...
                                    @foreach($parcelItems as $index => $row)
                                    <div class="item-card mb-4">
                                        <span class="item-number">Item #{{ $index + 1 }}</span>

                                        @if(count($parcelItems) > 1)
                                        <button type="button"
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-12">
                                                ...
                                                <select class="form-select @error("parcelItems.$index.parcel_category_id") is-invalid @enderror"
                                                    wire:model.live="parcelItems.{{ $index }}.parcel_category_id">
                                                    <option value="">-- Choose an item --</option>
                                                    @foreach($catalogueItems as $catalogue)
                                                    <option value="{{ $catalogue->id }}">{{ $catalogue->name }}</option>
                                                    @endforeach
                                                </select>
                                                @error("parcelItems.$index.parcel_category_id")
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-select"
                                                    wire:model.live="parcelItems.{{ $index }}.parcel_type">
                                                    <option value="">Select parcel type</option>
                                                    @foreach($parcelTypes as $value => $label)
                                                    <option value="{{ $value }}">{{ $label }}</option>
                                                    @endforeach
                                                </select>
                                                @error("parcelItems.$index.parcel_type")
                                                <div class="text-danger small mt-1">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-select"
                                                    wire:model.live="parcelItems.{{ $index }}.package_type">
                                                    @foreach($packageTypes as $value => $label)
                                                    <option value="{{ $value }}">{{ $label }}</option>
                                                    @endforeach
                                                </select>
                                                @error("parcelItems.$index.package_type")
                                                <div class="text-danger small mt-1">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="number" step="0.01" min="0"
                                                    class="form-control"
                                                    wire:model.live.debounce.750ms="parcelItems.{{ $index }}.declared_value"
                                                    placeholder="0.00">
                                                @error("parcelItems.$index.declared_value")
                                                <div class="text-danger small mt-1">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text" class="form-control"
                                                    wire:model="parcelItems.{{ $index }}.content_description"
                                                    placeholder="Describe this item">
                                                @error("parcelItems.$index.content_description")
                                                <div class="text-danger small mt-1">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text" class="form-control"
                                                    wire:model="parcelItems.{{ $index }}.special_notes"
                                                    placeholder="{{ !empty($row['payment_on_delivery']) ? 'Enter payment details (amount, method, etc.)' : 'Any special notes for this item' }}">
                                                @if(!empty($row['payment_on_delivery']))
                                                <small class="text-warning fw-semibold d-block mt-1">
                                                    <i class="bi bi-cash-coin me-1"></i>
                                                    Please provide payment details (amount to collect, payment method, etc.)
                                                </small>
                                                @endif
                                                @error("parcelItems.$index.special_notes")
                                                <div class="text-danger small mt-1">{{ $message }}</div>
                                                @enderror
                                            </div>

                                            <div class="col-12">
                                                <div class="form-check form-check-lg p-3 bg-light rounded-3 mb-2">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="insurance_{{ $index }}"
                                                        wire:model.live="parcelItems.{{ $index }}.insurance_required"
                                                        style="width: 20px; height: 20px; cursor: pointer;">
                                                    <label class="form-check-label fw-semibold ms-2"
                                                        for="insurance_{{ $index }}" style="cursor: pointer;">
                                                        <i class="bi bi-shield-shaded text-success me-2"></i>
                                                        Add insurance (2% of declared value)
                                                        @if(!empty($row['declared_value']) && (float)$row['declared_value'] > 0)
                                                        - <span class="text-success">
                                                            KES {{ number_format((float)$row['declared_value'] * 0.02, 2) }}
                                                        </span>
                                                        @endif
                                                    </label>
                                                </div>
                                                ...
                                                <div class="form-check form-check-lg p-3 bg-light rounded-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="pod_{{ $index }}"
                                                        wire:model.live="parcelItems.{{ $index }}.payment_on_delivery"
                                                        style="width: 20px; height: 20px; cursor: pointer;">
                                                    <label class="form-check-label fw-semibold ms-2"
                                                        for="pod_{{ $index }}" style="cursor: pointer;">
                                            ...
                                            <div class="col-12">
                                                <div class="row g-2 p-3 rounded-3" style="background:#f1f8e9;">
                                                    <div class="col-md-3 col-6">
                                                        <small class="text-muted">Base Price:</small>
                                                        <div class="fw-bold text-primary">
                                                            KES {{ number_format((float)($row['base_price'] ?? 0), 2) }}
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 col-6">
                                                        <small class="text-muted">Insurance:</small>
                                                        <div class="fw-bold text-success">
                                                            KES {{ number_format((float)($row['item_insurance_amount'] ?? 0), 2) }}
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 col-6">
                                                        <small class="text-muted">Tax (16%):</small>
                                                        <div class="fw-bold text-warning">
                                                            KES {{ number_format((float)($row['tax_amount'] ?? 0), 2) }}
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 col-6">
                                                        <small class="text-muted">Item Total:</small>
                                                        <div class="fw-bold text-success">
                                                            KES {{ number_format((float)($row['item_total'] ?? 0), 2) }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-12 mt-4">
                                        <label class="form-label">Special Instructions (whole parcel)</label>
                                        <textarea class="form-control" wire:model="special_instructions" rows="3"
                                    ...
                                    <div class="sticky-top" style="top: 100px;">
                                        ...
                                        <div class="card border-0 shadow-lg mb-4" style="background: linear-gradient(135deg, #2e7d32, #1b5e20); border-radius: 20px;">
                                            <div class="card-body p-4 text-white">
                                                ...
                                                <div class="text-white-50 small fw-medium">
                                                    <i class="bi bi-info-circle me-1"></i>
                                                    Totals update automatically as you change items
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mt-4 p-4 bg-success-soft rounded-4 border border-success border-opacity-25">
                                            <small class="text-success-emphasis d-block mb-2 fw-semibold">
                                                ...
                                                <strong>Items:</strong> {{ count($parcelItems) }}
                                            </small>
                                ...
                                <div class="card h-100 border-0 shadow-sm">
                                    <div class="card-header bg-white py-3">
                                        <h6 class="fw-bold mb-0">
                                            ...
                                            Items ({{ count($parcelItems) }})
                                        </h6>
                                    </div>
                                    <div class="card-body">
                                        @foreach($parcelItems as $i => $row)
                                        @php
                                            $cat = $row['parcel_category_id']
                                                ? collect($catalogueItems)->firstWhere('id', (int)$row['parcel_category_id'])
                                                : null;
                                        @endphp
                                        <div class="p-3 rounded-3 mb-3" style="background:#f1f8e9;">
                                            <div class="d-flex justify-content-between align-items-start mb-2">
                                                <strong>
                                                    Item #{{ $i + 1 }}:
                                                    {{ $cat->name ?? 'Unknown item' }}
                                                </strong>
                                                <span class="fw-bold text-success">KES {{ number_format((float)$row['item_total'], 2) }}</span>
                                            </div>
                                            <small class="text-muted d-block">
                                                Type: {{ $parcelTypes[$row['parcel_type']] ?? $row['parcel_type'] }}
                                                | Package: {{ $packageTypes[$row['package_type']] ?? $row['package_type'] }}
                                                | Value: KES {{ number_format((float)$row['declared_value'], 2) }}
                                            </small>
                                            <small class="text-muted d-block">
                                                Description: {{ $row['content_description'] }}
                                            </small>
                                            @if(!empty($row['insurance_required']))
                                            <small class="text-success d-block">
                                                <i class="bi bi-shield-check me-1"></i>
                                                Insurance: KES {{ number_format((float)$row['item_insurance_amount'], 2) }}
                                            </small>
                                            @endif
                                            @if(!empty($row['payment_on_delivery']))
                            ...
                            <div class="col-lg-6">
                                <div class="card border-0 shadow-sm">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @if($insurance_charge > 0)
                                        <div class="d-flex justify-content-between align-items-center mb-3 pb-2 border-bottom">
                                            <span class="fw-semibold fs-6">Insurance:</span>
