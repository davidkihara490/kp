        ...
        <style>
            ...
            *::after {
            ...
            @media (max-width:768px) {
                ...
                .parcels-table .contact-col,
                .parcels-table .details-col,
                .parcels-table .assignment-col {
                    grid-column: 1/-1
                }

                .parcels-table .status-col,
                .parcels-table .payment-col,
                .parcels-table .location-col,
                .parcels-table .date-col {
                    grid-column: span 1
                }

                .parcels-table .actions-col {
                    grid-column: 1/-1;
