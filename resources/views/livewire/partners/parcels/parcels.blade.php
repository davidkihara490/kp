                            ...
                            <tr class="{{ in_array($parcel->id, $selectedParcels) ? 'selected-row' : '' }}">
                                ...
                                <td>
                                    <div class="parcel-info-cell">
                                        ...
                                        <div class="parcel-deliverly-flow">
                                ...
                                */
                                ...
                                <td>
                                    @if($fromLocation)
                                    <strong>{{ $fromLocation?->town?->name ?? $fromLocation?->name }}</strong><br>
                                ...
                                <td>
                                    @if($toLocation)
                                    <strong>{{ $toLocation?->town?->name ?? $toLocation?->name }}</strong><br>
                    ...
                    <tbody>
                        ...
                        <tr class="{{ in_array($parcel->id, $selectedParcels) ? 'selected-row' : '' }}">
                            ...
                            */
                            ...
                            {{-- <td>
                                    @if($parcel->delivery_flow == 'final_destination')
                                    <strong> {{ $parcel->current_location['pick-up-drop-off-point']->name ?? '' }}</strong> <br>
                            <span class="badge bg-info">{{ $parcel->current_location['pick-up-drop-off-point']->town?->name ?? '' }}</span> <br>
                            <span class="badge bg-warning">{{ $parcel->current_location['pick-up-drop-off-point']->address ?? ''}} </span><br>
                            @else
                            ...
                            @elseif($parcel->current_status == 'warehouse')
                            <strong>{{ $parcel->warehouse?->town?->name }}</strong> <br>
                            <span class="badge bg-info">{{ $parcel->warehouse->name }}</span> <br>
                            <span class="badge bg-warning">{{ $parcel->warehouse->address }} </span><br>
                            @endif
                            @endif
