        ...
        <form wire:submit.prevent="updateProfile">
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <!-- Additional Documents based on partner type -->
                        @if($partner_type === 'transport')
                            <div class="col-md-4">
                                <label class="form-label fw-medium">Compliance Certificate</label>
                                <div class="document-upload">
                                    ...
                                    @if($current_compliance_certificate)
                                        <small class="text-success mt-1 d-block">
                                            <i class="fas fa-check-circle me-1"></i>
                                            Current file: {{ basename($current_compliance_certificate) }}
                                        </small>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <label class="form-label fw-medium">Insurance Certificate</label>
                                <div class="document-upload">
                                    ...
                                    @if($current_insurance_certificate)
                                        <small class="text-success mt-1 d-block">
                                            <i class="fas fa-check-circle me-1"></i>
                                            Current file: {{ basename($current_insurance_certificate) }}
                                        </small>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <label class="form-label fw-medium">Drivers Certificate</label>
                                <div class="document-upload">
                                    ...
                                    @if($current_drivers_certificate)
                                        <small class="text-success mt-1 d-block">
                                            <i class="fas fa-check-circle me-1"></i>
                                            Current file: {{ basename($current_drivers_certificate) }}
                                        </small>
                                    @endif
                                </div>
                            </div>
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    <div class="row g-3 mb-4">
                        ...
                        @if($has_dedicated_allocator)
                            <div class="col-md-4">
                                <label class="form-label fw-medium">Allocator Name</label>
                                <input type="text" class="form-control" 
                                       wire:model="allocator_name" 
                                       placeholder="Enter allocator name">
                            </div>
                            
                            <div class="col-md-4">
                                <label class="form-label fw-medium">Allocator Phone</label>
                                <input type="text" class="form-control" 
                                       wire:model="allocator_phone" 
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-12">
                            <h6 class="fw-bold mb-3">Booking Notification Emails</h6>
                            <div class="email-input-group">
                                <div class="input-group mb-2">
                                    <input type="email" class="form-control" 
                                           wire:model="new_email" 
                                           placeholder="Enter email for booking notifications"
                                           wire:keydown.enter.prevent="addBookingEmail">
                                    <button class="btn btn-outline-primary" type="button" 
                                            wire:click="addBookingEmail">
                                        <i class="fas fa-plus"></i> Add
                                    </button>
                                </div>
                                
                                <div class="email-list mt-2">
                                    @foreach($booking_emails as $index => $email)
                                        <div class="email-item d-flex justify-content-between align-items-center p-2 mb-2 bg-light rounded">
                                            <span>{{ $email }}</span>
                                            <button type="button" class="btn btn-sm btn-outline-danger"
                                                    wire:click="removeBookingEmail({{ $index }})">
                            ...
                            @error('booking_emails.*') <span class="text-danger small">{{ $message }}</span> @enderror
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-4">
                            <label class="form-label fw-medium">Years in Operation</label>
                            <div class="input-group">
                                <input type="number" class="form-control" 
                                       wire:model="years_in_operation" min="0" max="100"
                        ...
                        <div class="col-md-4">
                            <label class="form-label fw-medium">Insurance Coverage Amount</label>
                            <div class="input-group">
                                <span class="input-group-text">$</span>
                                <input type="number" class="form-control" 
                                       wire:model="insurance_coverage_amount" min="0"
                                       placeholder="Coverage amount">
                            </div>
                        </div>
                        
                        <div class="col-md-4">
                            <label class="form-label fw-medium">Previous Courier Experience</label>
                            <input type="text" class="form-control" 
                                   wire:model="previous_courier_experience" 
                                   placeholder="e.g., 5 years in logistics">
                        </div>
                        
                        <div class="col-md-6">
                            <label class="form-label fw-medium">Safety Measures</label>
                            <textarea class="form-control" rows="3"
                                      wire:model="safety_measures" 
                                      placeholder="Describe safety measures implemented..."></textarea>
                        </div>
                        
                        <div class="col-md-6">
                            <label class="form-label fw-medium">Tracking System</label>
                            <textarea class="form-control" rows="3"
                                      wire:model="tracking_system" 
                                      placeholder="Describe your tracking system..."></textarea>
                        </div>
