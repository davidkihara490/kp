    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title font-weight-bold d-inline">
                <i class="fas fa-plus-circle mr-2"></i>Create New Blog Post
            </h3>
            <a href="{{ route('admin.blog-posts.index') }}" class="btn btn-secondary btn-sm float-right">
        ...
        <div class="card-body">
            ...
            <form wire:submit.prevent="save" x-data="{ activeTab: 'content' }">
                <!-- Tabs Navigation -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">
                                    URL: /blog/<strong>{{ $slug ?: 'your-slug' }}</strong>
                                </small>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" 
                                           ...
                                           wire:keydown.enter.prevent="createNewTag">
                                    <div class="input-group-append">
                ...
                <div x-show="activeTab === 'seo'" class="space-y-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0"><i class="fab fa-facebook mr-2"></i>Open Graph (Facebook)</h5>
                        </div>
                        <div class="card-body">
                            <div class="form-group">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('sitemap_priority') is-invalid @enderror" 
                                                id="sitemap_priority" 
                                                wire:model="sitemap_priority">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('sitemap_change_frequency') is-invalid @enderror" 
                                        id="sitemap_change_frequency" 
                                        wire:model="sitemap_change_frequency">
                ...
                <div x-show="activeTab === 'images'" class="space-y-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0"><i class="fas fa-camera mr-2"></i>SEO Images</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if($temp_meta_image || $meta_image)
                                            <div class="mb-2">
                                                <img src="{{ $temp_meta_image ?: ($meta_image ? $meta_image->temporaryUrl() : '') }}" 
                                                     alt="Meta Image" 
                                                     class="img-fluid rounded"
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label">
                                                {{ $meta_image ? 'Change meta image...' : 'Choose meta image...' }}
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if($temp_og_image || $og_image)
                                            <div class="mb-2">
                                                <img src="{{ $temp_og_image ?: ($og_image ? $og_image->temporaryUrl() : '') }}" 
                                                     alt="OG Image" 
                                                     class="img-fluid rounded"
                                                     style="max-height: 150px;">
                                            </div>
                                        ...
                                        <div class="custom-file">
                                            <input type="file" 
                                                   ...
                                                   accept="image/*">
                                            <label class="custom-file-label">
                                                {{ $og_image ? 'Change OG image...' : 'Choose OG image...' }}
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if($temp_twitter_image || $twitter_image)
                                            <div class="mb-2">
                                                <img src="{{ $temp_twitter_image ?: ($twitter_image ? $twitter_image->temporaryUrl() : '') }}" 
                                                     alt="Twitter Image" 
                                                     class="img-fluid rounded"
                                                     style="max-height: 150px;">
                                            </div>
                                        ...
                                        <div class="custom-file">
                                            <input type="file" 
                                                   ...
                                                   accept="image/*">
                                            <label class="custom-file-label">
                                                {{ $twitter_image ? 'Change Twitter image...' : 'Choose Twitter image...' }}
                                            </label>
                                        </div>
                                    </div>
                                </div>
                ...
                <div x-show="activeTab === 'settings'" class="space-y-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0"><i class="fas fa-paper-plane mr-2"></i>Publishing Settings</h5>
                        </div>
                        <div class="card-body">
                            <div class="form-group">
