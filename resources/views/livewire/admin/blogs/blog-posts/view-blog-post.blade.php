                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    @if ($post->category)
                                    <a href="{{ route('admin.blog-categories.view', $post->category->id) }}"
                                    ...
                                    <a href="{{ route('admin.blog-tags.view', $tag->id) }}"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3 pb-3 {{ !$loop->last ? 'border-bottom' : '' }}">
                                    <h6 class="mb-1">
                                        <a href="{{ route('admin.blog-posts.view', $related->id) }}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3 pb-3 {{ !$loop->last ? 'border-bottom' : '' }}">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            <h6 class="mb-1">
                                                <a href="{{ route('admin.blog-posts.view', $popular->id) }}"
