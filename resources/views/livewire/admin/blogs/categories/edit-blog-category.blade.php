    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title font-weight-bold d-inline">
                <i class="fas fa-edit mr-2"></i>Edit Category: {{ $category->name }}
            </h3>
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if($category->children()->count() > 0)
                                                <small class="text-warning">
                                                    ...
                                                    Changing parent may affect them.
                                                </small>
                                            @endif
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body text-center">
                                @if($temp_featured_image || $current_image)
                                    <div class="mb-3">
                                        <img src="{{ $temp_featured_image ?: ($current_image ? asset('storage/' . $current_image) : '') }}" 
                                             alt="Featured Image" 
