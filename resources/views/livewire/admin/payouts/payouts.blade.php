                ...
                <div class="col-md-3 col-sm-6">
                    <div class="info-box bg-gradient-danger">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">KES {{ number_format($cancelledTotal, 2) }}</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                            ...
                            <td class="text-center">
                                <div class="btn-group" role="group">
                                    ...
                                    <button class="btn btn-sm btn-danger"
                                        wire:click="confirmDelete({{ $payout->id }})"
                                        title="Delete">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    @elseif($selectedPayout->destination)
                                    <table class="table table-sm">
                                        <tr>
                                            <th>Destination:</th>
                                            <td>{{ $selectedPayout->destination->name }}</td>
                                        </tr>
                                        @if($selectedPayout->destination->address)
                                        <tr>
                                            <th>Address:</th>
                                            <td>{{ $selectedPayout->destination->address }}</td>
                                        </tr>
                                        @endif
                                    </table>
                                    @else
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control" 
                                wire:model="processAmount" required>
