                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title font-weight-bold">
                            <i class="fas fa-user-plus"></i> Create New Parcel Handling Assistant
                        </h3>
                        <div class="card-tools">
                            <button type="button" class="btn btn-tool" wire:loading.remove>
                                    ...
                                    <div class="card card-outline card-warning mt-3">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <small class="form-text text-muted">Auto-generated from email if left empty</small>
                                                @error('username')
                                                    <span class="invalid-feedback">{{ $message }}</span>
                                                @enderror
                                            </div>
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary" wire:loading.attr="disabled">
                                        <span wire:loading.remove>
                                            <i class="fas fa-save"></i> Create Assistant
                                        </span>
                                        <span wire:loading>
                                    ...
                                    <button type="reset" class="btn btn-warning" wire:click="$set('fields', [])">
...
@push('scripts')
<script>
    // Optional: Add any custom JavaScript for additional functionality
    document.addEventListener('livewire:initialized', () => {
        // Auto-generate username when email is entered
        Livewire.hook('element.updated', (el, component) => {
            if (el.id === 'email' && document.getElementById('username').value === '') {
                let email = el.value;
