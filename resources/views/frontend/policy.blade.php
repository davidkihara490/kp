...
<head>
    ...
    <title>Privacy Policy | Karibu Parcels</title>
    <!-- Bootstrap 5 CSS -->
    ...
    <div class="container">
        <div class="privacy-card">
            <div class="last-updated">
                <i class="bi bi-calendar-check"></i> Last Updated: {{ $policy->updated_at->format('Y-M-d') }}
            </div>
        ...
        document.querySelectorAll('a[href^="#"]').forEach(anchor => {
            anchor.addEventListener('click', function(e) {
                if(this.getAttribute('href') !== '#') {
                    ...
                    if(targetId === '#') return;
                    // if linking to main page sections, but we are on privacy page, we redirect to home with hash
