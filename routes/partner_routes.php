...
Route::middleware(['partner.auth'])->prefix('partners')->as('partners.')->group(function () {
...
//     Route::get('/marketplace/parcels', [MarketplaceController::class, 'getAvailableParcels'])->name('marketplace.parcels');
//     Route::get('/marketplace/parcels/{parcel}', [MarketplaceController::class, 'getParcelDetails']);
//     Route::post('/marketplace/bids', [MarketplaceController::class, 'placeBid']);
//     Route::get('/marketplace/drivers', [MarketplaceController::class, 'getDrivers']);
//     Route::post('/marketplace/assign-driver', [MarketplaceController::class, 'assignDriver']);
//     Route::get('/marketplace/available-vehicles', [MarketplaceController::class, 'getAvailableVehicles']);
//     Route::get('/marketplace/export', [MarketplaceController::class, 'exportResults']);
// });