...
class ParcelHandlingAssistants extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.admin.parcel-handling-assistants.parcel-handling-assistants', [
            'assistants' => $assistants,
            'pickUpAndDropOffPoints' => PickUpAndDropOffPoint::where('status', 'active')->orderBy('id')->get(),
            'statuses' => [
                '' => 'All Status',
                'active' => 'Active',
                'inactive' => 'Inactive',
