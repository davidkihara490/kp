...
class Marketplace extends Component
{
    ...
    //         'selected_warehouse_id' => 'required_if:delivery_option,warehouse|exists:warehouses,id'
    //     ]);

    //     // Save the delivery option to the parcel
    //     $this->selectedParcel->delivery_option = $this->delivery_option;
    //     $this->selectedParcel->assigned_warehouse_id = $this->delivery_option === 'warehouse' ? $this->selected_warehouse_id : null;
    //     $this->selectedParcel->partner_payout = $this->calculated_payout;
    //     $this->selectedParcel->save();

    //     $this->showDeliveryOptionModal = false;
    //     $this->showPayoutConfirmationModal = true;
    // }
    ...
    public function confirmDeliveryOption()
    {
        ...
        try {
            ...
            $parcelStatus = $this->selectedParcel->updateParcelStatus(
